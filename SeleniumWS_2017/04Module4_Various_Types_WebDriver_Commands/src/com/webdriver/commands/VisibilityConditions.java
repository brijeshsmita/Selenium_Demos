...
public class VisibilityConditions{
	public static void main(String[] args) {
		...
		boolean searchIconPresence = driver.findElement(By.id("_fZl")).isDisplayed();

		boolean searchIconEnabled = driver.findElement(By.id("_fZl")).isEnabled();

		if(searchIconPresence==true && searchIconEnabled==true)
		{
			// click on the search button
			WebElement searchIcon = driver.findElement(By.id("_fZl"));
			searchIcon.click();
		}else
		{
			System.out.println("Google search button not available");
		}
